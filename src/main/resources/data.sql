...
insert
    ...
    values(null, '2020-12-20T20:00:00.0', '2020-02-20T21:00:00.0', 1); --id=1
insert
    into schedule(id, start_date_time, end_date_time, tennis_court_id) --id=2
    values(null, '2030-12-01T10:00:00.0', '2030-12-01T11:00:00.0', 1);
insert --id=1
    into schedule(id, start_date_time, end_date_time, tennis_court_id) --id=3
    values(null, '2030-12-01T12:00:00.0', '2030-12-01T13:00:00.0', 1);
insert --id=1
    into schedule(id, start_date_time, end_date_time, tennis_court_id) --id=4
    values(null, '2030-12-01T18:00:00.0', '2030-12-01T19:00:00.0', 1);
insert --id=1
    into schedule(id, start_date_time, end_date_time, tennis_court_id) --id=5
